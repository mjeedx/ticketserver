...
RUN python3 /srv/ticketserver/manage.py collectstatic --noinput
RUN python3 /srv/ticketserver/manage.py makemigrations
RUN python3 /srv/ticketserver/manage.py migrate
