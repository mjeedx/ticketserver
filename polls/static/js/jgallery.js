...
var defaults = {
    ...
    tooltipFullScreen: 'Полный экран', // String; Text of tooltip which will be displayed next to icon for change display mode.; ; [ 'Full screen', 'Tryb pełnoekranowy' ]
    ...
    tooltipSeeAllPhotos: 'Смотреть все фото', // String; Text of tooltip which will be displayed next to icon for change thumbnails view.; ; [ 'See all photos', 'Zobacz wszystkie zdjęcia' ]
    tooltipSeeOtherAlbums: 'Смотреть другие альбомы', // String; Text of tooltip which will be displayed next to icon for change album(if your jGallery has more than one album).; ; [ 'See other albums', 'Zobacz pozostałe albumy' ]
    ...
    tooltipToggleThumbnails: 'Убрать панель', // String; Text of tooltip which will be displayed next to icon for toggle thumbnails.; ; [ 'Toggle thumbnails', 'Pokaż/ukryj miniatury' ]
    ...
    JGallery.prototype = {
            ...
            html: '<div class="jgallery" style="display: none;">\
                        ...
                        <div class="zoom-container">\
                            ...
                            <div class="nav-bottom">\
                                ...
                                <div class="icons1">\
                                    <span class="fa fa-cloud-upload jgallery-btn jgallery-btn-small" style="margin-left: 90px"><a href="/polls/upload/" style="padding-left: 5px; font-size: 0.8em; font-family: Arial;">Загрузить_фото</a></span>\
                                    <span class="fa fa-thumbs-up jgallery-btn jgallery-btn-small" style="margin-left: 130px"><a id="clickbutton" href="/polls/votepage/" style="padding-left: 5px; color: #3cb521; font-size: 0.8em; font-family: Arial;">Перейти_к_голосованию</a></span>\
                                </div>\
        ...
        generateAlbumsDropdown: function() {
            ...
            this.zoom.$container.find( '.nav-bottom > .icons' ).append( '\
                <span class="fa fa-list-ul change-album jgallery-btn jgallery-btn-small" style="margin-left: 1px" tooltip="' + self.options.tooltipSeeOtherAlbums + '">\
